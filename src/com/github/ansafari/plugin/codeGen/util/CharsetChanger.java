...
public class CharsetChanger {
     ...
     * 将字符编码转换成ISO-8859-1码
     */
    public String toISO_8859_1(String str) throws Exception {
     ...
     * 将字符编码转换成UTF-8码
     */
    public String toUTF_8(String str) throws Exception {
     ...
     * 将字符编码转换成UTF-16BE码
     */
    public String toUTF_16BE(String str) throws Exception {
     ...
     * 将字符编码转换成UTF-16LE码
     */
    public String toUTF_16LE(String str) throws Exception {
     ...
     * 将字符编码转换成UTF-16码
     */
    public String toUTF_16(String str) throws Exception {
     ...
     * 将字符编码转换成US-ASCII码
     */
    public String toASCII(String str, String from) throws Exception {
